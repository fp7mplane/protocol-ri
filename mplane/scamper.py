...
def ping4_aggregate_capability(ipaddr):
    ...
    cap.add_parameter("scamper.ping.dport",-1)
    cap.add_parameter("scamper.ping.sport",-1)
    cap.add_parameter("scamper.ping.ttl",64)
    cap.add_parameter("scamper.ping.rcount",0)
    cap.add_parameter("scamper.ping.pattern","")
    cap.add_parameter("scamper.ping.method","icmp-echo")
    cap.add_parameter("scamper.ping.rr",0)
    cap.add_parameter("scamper.ping.size",84)
    cap.add_parameter("scamper.ping.tos",0)
...
def ping6_aggregate_capability(ipaddr):
    ...
    cap.add_parameter("scamper.ping.method","icmp-echo")
    cap.add_parameter("scamper.ping.rr",0)
    cap.add_parameter("scamper.ping.size",56)
    cap.add_parameter("scamper.ping.tos",0)
    cap.add_result_column("delay.twoway.icmp.us.min")
    cap.add_result_column("delay.twoway.icmp.us.mean")
    cap.add_result_column("delay.twoway.icmp.us.max")
...
def ping6_singleton_capability(ipaddr):
    cap = mplane.model.Capability(label="scamper-ping-single-ip6", when = "now ... future / 1s")
    cap.add_parameter("source.ip6",ipaddr)
    cap.add_parameter("destination.ip6")
    cap.add_parameter("scamper.ping.payload","")
    cap.add_parameter("scamper.ping.icmp.checksum","")
...
def trace4_standard_capability(ipaddr):
    ...
    cap.add_parameter("scamper.trace.confidence",-1)
    cap.add_parameter("scamper.trace.dport",-1)
    cap.add_parameter("scamper.trace.firsthop",1)
    cap.add_parameter("scamper.trace.gaplimit",5)
    cap.add_parameter("scamper.trace.gapaction",1)
    cap.add_parameter("scamper.trace.maxttl",255)
    cap.add_parameter("scamper.trace.M",0)
    cap.add_parameter("scamper.trace.loops",1)
    cap.add_parameter("scamper.trace.loopaction",-1)
    cap.add_parameter("scamper.trace.payload","")
    cap.add_parameter("scamper.trace.method","UDP-paris")
    cap.add_parameter("scamper.trace.attempts",2)
    cap.add_parameter("scamper.trace.Q",0)
    cap.add_parameter("scamper.trace.sport",-1)
    cap.add_parameter("scamper.trace.srcaddr",1)
    cap.add_parameter("scamper.trace.tos",0)
    cap.add_parameter("scamper.trace.T",0)
    cap.add_parameter("scamper.trace.userid",-1)
    cap.add_parameter("scamper.trace.wait",5)
    cap.add_parameter("scamper.trace.waitprobe",-1)
...
def tracelb4_standard_capability(ipaddr):
    ...
    cap.add_parameter("scamper.tracelb.confidence",95)
    cap.add_parameter("scamper.tracelb.dport",33435)
    cap.add_parameter("scamper.tracelb.firsthop",-1)
    cap.add_parameter("scamper.tracelb.gaplimit",3)
    cap.add_parameter("scamper.tracelb.method","udp-dport")
    cap.add_parameter("scamper.tracelb.attempts",2)
    cap.add_parameter("scamper.tracelb.maxprobec",3000)
    cap.add_parameter("scamper.tracelb.sport",-1)
    cap.add_parameter("scamper.tracelb.tos",0)
    cap.add_parameter("scamper.tracelb.userid",-1)
    cap.add_parameter("scamper.tracelb.waittimeout",5)
    cap.add_parameter("scamper.tracelb.waitprobe",25)
...
class ScamperService(mplane.scheduler.Service):
    ...
    def __input_trace(self,spec):
        ...
        userid     = spec.get_parameter_value("scamper.trace.userid")
    ...
    def __input_tracelb(self,spec):
        ...
        userid      = spec.get_parameter_value("scamper.tracelb.userid")
...
class HttpProbe():
    ...
    def __init__(self, immediate_ms = 5000):
        ...
        if args.IP4 is not None:
            self.scheduler.add_service(ScamperService(tracebox4_standard_capability(args.IP4)))
            self.scheduler.add_service(ScamperService(tracebox4_specific_capability(args.IP4)))
            self.scheduler.add_service(ScamperService(tracebox4_specific_quotesize_capability(args.IP4)))
            self.scheduler.add_service(ScamperService(ping4_aggregate_capability(args.IP4)))
            self.scheduler.add_service(ScamperService(ping4_singleton_capability(args.IP4)))
            self.scheduler.add_service(ScamperService(trace4_standard_capability(args.IP4)))
            self.scheduler.add_service(ScamperService(tracelb4_standard_capability(args.IP4)))

        if args.IP6 is not None:
            self.scheduler.add_service(ScamperService(ping6_aggregate_capability(args.IP6)))
            self.scheduler.add_service(ScamperService(ping6_singleton_capability(args.IP6)))
            self.scheduler.add_service(ScamperService(tracebox6_standard_capability(args.IP6)))
            self.scheduler.add_service(ScamperService(tracebox6_specific_capability(args.IP6)))
            self.scheduler.add_service(ScamperService(tracebox6_specific_quotesize_capability(args.IP6)))    
            self.scheduler.add_service(ScamperService(trace6_standard_capability(args.IP6)))
            self.scheduler.add_service(ScamperService(tracelb6_standard_capability(args.IP6)))
