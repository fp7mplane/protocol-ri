...
Ext.define('NV.mplane.gui.Constants',{
	...
	capabilityMenu:{
            'capabilities':{
            	label:'Kártyák és mérések',
            	type:'capability',
            	icon:'list.png'
            },
            'pending':{
            	label:'Befejeződött mérések',
            	type:'pending',
            	icon:'run.png'
            },
            'ondeamand':{
            	label:'Mérés előjegyzés',
            	type:'ondemand',
            	icon:'dashboard.png'
            }
	},
	...
	urls:{
		...
		gridUrl: 'resource/mplane-gui/json/nmhhGridDefinition.json',
	...
	testUrls:{
		capabilityList: "test/json/nmhhcapabilities.json",
		registry: "test/json/registry.json",
		gridUrl: 'resource/mplane-gui/json/nmhhGridDefinition.json',
		runUrl: 'resource/mplane-gui/json/nmhhGridDefinition.json',
		stopUrl: 'resource/mplane-gui/json/nmhhGridDefinition.json',
					   ...
					   Ext.Ajax.request({
						  ...
						  success: function(response){
							  var json = NV.ext.ux.nv.GlobalErrorHandler.jsonResponseErrorHandler(response);
	  							...
	  							window.location.href='nmhh.html';
						  },
						  scope:this
					   });
				   },
...
Ext.define('NV.mplane.gui.Main',{
	...
	init: function(){
		...
		var array = document.location.search.substr(document.location.search.search("nmhh.html?") + 1).split("&");
	...
	continueInit: function(currentUsersSettings){
		...
		this.tabPanel = Ext.create('Ext.tab.Panel', {
			...
			items : [{
				...
				items:[
				  { xtype:'panel', width:700, height:300, x:20, y:20, 
					html: "<H2>Card A</h2><h3>Dektec DT 3237C</h3>", 
					layout:"absolute", bodyStyle: 'background:#eef;padding:7px',
                                            items: [
						{  width:500, height:120, x:150, y:20, bodyStyle: 'background:#ffc;padding:7px', html: 
							'<table cellpadding=5 cellspacing=5><tr><td>\
							<H3>Port #1</h3>\
							<img src="resource/red.png" height="20"/>\
							</td><td>\
							<table border=1>\
								<tr><td>Felhasználó</td><td>KovacsA</td></tr>\
								<tr><td>Feladat</td><td>BlindScan</td></tr>\
								<tr><td>Várható vége:</td><td>10.12 18:57</td></tr>\
							</table>\
							</td><td>\
								<button>Beállítás/<br>Megtekintés</button>\
							</td></tr></table>'
							},
						{  width:500, height:120, x:150, y:150, bodyStyle: 'background:#ffc;;padding:7px', html: 
							'<table cellpadding=5 cellspacing=5><tr><td>\
							<H3>Port #1</h3>\
							<img src="resource/green.png" height="20"/>\
							</td><td>\
							<table border=1>\
								<tr><td>Felhasználó</td><td> n/a </td></tr>\
								<tr><td>Feladat</td><td> - - szabad - - </td></tr>\
								<tr><td>Várható vége:</td><td></td></tr>\
							</table>\
							</td><td>\
								<button>Beállítás/<br>Megtekintés</button>\
							</td></tr></table>'
				  ...
				  { xtype:'panel', width:700, height:300, x:20, y:330, 
					html: "<H2>Card B</h2><h3>Dektec DT 3237C</h3>", 
					layout:"absolute", bodyStyle: 'background:#eef;padding:7px',
                                            items: [
						{  width:500, height:120, x:150, y:20, bodyStyle: 'background:#ffc;padding:7px', 
							html: 
							'<table cellpadding=5 cellspacing=5><tr><td>\
							<H3>Port #1</h3>\
							<img src="resource/yellow.png" height="20"/>\
							</td><td>\
							<table border=1>\
								<tr><td>Felhasználó</td><td>SzaboB</td></tr>\
								<tr><td>Feladat</td><td>TP Import</td></tr>\
								<tr><td>Várható vége:</td><td>10.12 18:57</td></tr>\
							</table>\
							</td><td>\
								<button>Beállítás/<br>Megtekintés</button>\
						...
						{  width:500, height:120, x:150, y:150, bodyStyle: 'background:#ffc;padding:7px', 
							html: 
							'<table cellpadding=5 cellspacing=5><tr><td>\
							<H3>Port #1</h3>\
							<img src="resource/grey.png" height="20"/>\
							</td><td>\
							<table border=1>\
								<tr><td>Felhasználó</td><td> n/a </td></tr>\
								<tr><td>Feladat</td><td> - - inaktív - - </td></tr>\
								<tr><td>Várható vége:</td><td></td></tr>\
							</table>\
							</td><td>\
								<button>Beállítás/<br>Megtekintés</button>\
...
Ext.define('NV.mplane.gui.windows.RunWindow',{
	...
	constructor:function(config){
		...
		var whenStore = new Ext.data.Store({
//		    model: 'User',
		    proxy: {
		        type: 'ajax',
		        url : '/gui/static/history.json',
		        reader: {
		            type: 'json',
		            root: 'when'
		        }
