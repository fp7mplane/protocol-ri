...
(SOUND_FORMAT_PCM_PLATFORM_ENDIAN,
 ...
 SOUND_FORMAT_G711_MU_LAW) = list(range(9))

(SOUND_FORMAT_AAC,
 SOUND_FORMAT_SPEEX) = list(range(10, 12))

(SOUND_FORMAT_MP3_8KHZ,
 SOUND_FORMAT_DEVICE_SPECIFIC) = list(range(14, 16))
...
(SOUND_RATE_5_5_KHZ,
 SOUND_RATE_11_KHZ,
 SOUND_RATE_22_KHZ,
 SOUND_RATE_44_KHZ) = list(range(4))
...
# Sound size
(SOUND_SIZE_8_BIT, SOUND_SIZE_16_BIT) = list(range(2))
...
# Sound type
(SOUND_TYPE_MONO, SOUND_TYPE_STEREO) = list(range(2))
...
(AAC_PACKET_TYPE_SEQUENCE_HEADER,
 AAC_PACKET_TYPE_RAW) = list(range(2))
...
(FRAME_TYPE_KEYFRAME,
 ...
 FRAME_TYPE_INFO_FRAME) = list(range(1, 6))
...
(H264_PACKET_TYPE_SEQUENCE_HEADER,
 ...
 H264_PACKET_TYPE_END_OF_SEQUENCE) = list(range(3))
...
(VALUE_TYPE_NUMBER,
 ...
 VALUE_TYPE_ECMA_ARRAY) = list(range(9))

(VALUE_TYPE_STRICT_ARRAY,
 VALUE_TYPE_DATE,
 VALUE_TYPE_LONGSTRING) = list(range(10, 13))
